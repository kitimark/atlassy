...
Define a deterministic, provenance-stamped attestation evidence layer for readiness so gates can consume trusted external evidence without breaking existing batch-manifest workflows.
