...
Define release automation behavior for release-plz configuration, release PR and release execution workflows, GitHub permissions, versioning, and release packaging prerequisites.
