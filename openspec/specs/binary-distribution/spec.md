...
Define binary distribution behavior for cross-platform release builds, packaged artifacts, checksum integrity, release asset publication, and install documentation.
